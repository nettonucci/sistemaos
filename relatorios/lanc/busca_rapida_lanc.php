<?php 
    ...
    $con = open_conexao(); 
    $rs = mysqli_query($con,"SELECT * FROM caixa INNER JOIN for_pgto ON (caixa.mtdpgto = for_pgto.id)");
?>
...
<head>
  ...
  <title>Relatorio rapido de lançamento</title>
...
<body>
    ...
    <hr>
    <div>
    <h5><?php echo 'Relatório rápido de lançamentos';?></h5>
    <hr>
    <?php
