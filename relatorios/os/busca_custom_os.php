<?php 
    ...
    $con = open_conexao(); 
    $sql = mysqli_query($con, "SELECT * FROM os INNER JOIN clientes ON (os.idcliente = clientes.id) WHERE dataentrada BETWEEN '$datainicial' AND '$datafinal'; ");
