  ...
  <li class="nav-item">
      ...
      <div id="content-wrapper">
        ...
        <!-- /Informacoes aqui -->
           ...
           <form data-toggle="validator" method="post" action="estoque/busca_rapida_estoque.php" target="_blank">
          ...
          <div class="container">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <button class="btn btn-light btn-block"><i class="fas fa-boxes"></i> Todo o estoque</button>
              ...
              <div class="col-6">
              <form data-toggle="validator" method="post" action="estoque/busca_custom_estoque.php" target="_blank">
          <link rel="stylesheet" href="http://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
          <div class="card mb-3" style="width: 100%;">
            <div class="card-header">
            <i class="far fa-list-alt"></i>
        ...
        <div class="col-15">
              <form data-toggle="validator" method="post" action="estoque/busca_custom_estoque2.php" target="_blank">
          <link rel="stylesheet" href="http://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
          <div class="card mb-3" style="width: 100%;">
            <div class="card-header">
            <i class="far fa-list-alt"></i>
              ...
              <div class="table-responsive">
                ...
                <div class="span12 well">
                    <div class="span4">
                        ...
                        <input type="text" name="quantidade" class="span12" />
                    </div>
                    <br>
                    <div class="span4">
                        <label for=""></label>
