  ...
  <li class="nav-item">
      ...
      <div id="content-wrapper">
        ...
        <!-- /Informacoes aqui -->
           ...
           <form data-toggle="validator" method="post" action="vendas/busca_rapida_vendas.php" target="_blank">
          ...
          <div class="container">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <button class="btn btn-light btn-block"><i class="fas fa-shopping-cart"></i> Todas as vendas</button>
              ...
              <div class="col-6">
              <form data-toggle="validator" method="post" action="vendas/busca_custom_vendas.php" target="_blank">
          <link rel="stylesheet" href="http://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
          <div class="card mb-3" style="width: 100%;">
            <div class="card-header">
            <i class="far fa-list-alt"></i>
        ...
        <div class="col-15">
              <form data-toggle="validator" method="post" action="vendas/busca_custom_vendas2.php" target="_blank">
          <link rel="stylesheet" href="http://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
          <div class="card mb-3" style="width: 100%;">
            <div class="card-header">
            <i class="far fa-list-alt"></i>
