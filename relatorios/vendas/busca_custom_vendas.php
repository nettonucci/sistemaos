<?php 
    ...
    $con = open_conexao(); 
    $sql = mysqli_query($con, "SELECT * FROM vendas WHERE datavenda BETWEEN '$datainicial' AND '$datafinal'; ");
 
    $sql2 = mysqli_query($con, "SELECT count(*) AS qtd FROM vendas WHERE datavenda BETWEEN '$datainicial' AND '$datafinal'; "); 
...
<head>
  ...
  <title>Relatorio Customisado de vendas</title>
...
<body>
    ...
    <div>
    <h5><?php 
    echo 'Relatório customizado de vendas - ';
    echo 'vendas entre as datas: ';
    echo $datainicial;
    echo ' a ';
    echo $datafinal;
    ?></h5>
