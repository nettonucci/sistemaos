<?php 
    ...
    $con = open_conexao(); 
    $sql = mysqli_query($con, "SELECT * from vendas WHERE tipovenda =".$tipo);
 
    $sql2 = mysqli_query($con, "SELECT count(*) AS qtd FROM vendas WHERE tipovenda =".$tipo); 
